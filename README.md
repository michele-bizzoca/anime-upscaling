...
I also made a program, Anime Ultrascale, that runs the workflow automatically and is fully customizable. It provides several useful features like a progress bar, save & playback, and advanced logging. It is available as a single python file that you can run on any operative system. Installation files for Ubuntu are included:

<p align="center">💻 <a href=https://github.com/michele-bizzoca/anime-ultrascale><strong>Go to the Program</strong></a>
<p>
