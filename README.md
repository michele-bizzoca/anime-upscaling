...
With the purpose of bridging the gap between AI technology and user experience, I devised a workflow for extreme restoration of anime images, which can be executed with freely available and simple-to-use tools. It is presented, with an example of 170x resolution increase, in the article [**Anime Upscaling**](https://https://michele-bizzoca.github.io/anime-upscaling/).

Later, i turned Anime Upscaling into a fully automatic program with useful features like a progress bar, save & playback, and advanced logging. Its name is [**Anime Ultrascale**](https://github.com/michele-bizzoca/anime-ultrascal).
